        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php $facilityClubRows = $facilityClubs[(int) $facility->id] ?? []; ?>
                        <?php if ($facilityClubRows): ?>
                            <?php foreach (array_slice($facilityClubRows, 0, 2) as $facilityClub): ?><span class="badge bg-light text-dark border me-1"><?= esc($facilityClub->name_vi) ?></span><?php endforeach; ?>
                            <?php if (count($facilityClubRows) > 2): ?><small class="text-muted">+<?= count($facilityClubRows) - 2 ?> CLB</small><?php endif; ?>
                        <?php else: ?><span class="text-muted">Chưa gán</span><?php endif; ?>
                    </td>
                    <td>
                    ...
                    <td class="text-end">
                        ...
                        <a href="/admin/facilities/clubs/<?= $facility->id ?>" class="btn btn-sm btn-outline-success" title="Quản lý CLB"><i class="bi bi-building-heart"></i></a>
